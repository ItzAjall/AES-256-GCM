...
A simple and secure AES-256-GCM encryption/decryption REST API built with Java 21 and Spring Boot, now featuring a modern Dark Glassmorphism web interface.
...
- RESTful API
- **Modern Glassmorphism Web Interface** included
...
To make it easier to test and visualize the API in action, a single-page web interface is included in the project. 

**Note:** The core of this project is the Java Spring Boot API. This frontend was entirely generated by AI specifically to demonstrate and showcase how the API works. It features a modern "Dark Glassmorphism" aesthetic with glowing animated backgrounds, frosted glass containers, and polished toast notifications.
...
The generated key represents 32 random bytes (256 bits). Keep this key secret.
...
The encrypted value contains the randomly generated IV followed by the ciphertext and GCM authentication tag. Encrypting the same plaintext multiple times with the same key produces different ciphertext because a new IV is generated for every operation.
